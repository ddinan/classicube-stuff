...
namespace MCGalaxy
{
    ...
    public sealed class MobAI : Plugin
    {
        ...
        public override void Load(bool startup)
        {
            ...
            BotInstruction.Instructions.Add(parkour);
        ...
        public override void Unload(bool shutdown)
        {
            ...
            BotInstruction.Instructions.Remove(parkour);
    ...
    sealed class ParkourInstruction : BotInstruction
    {
        public ParkourInstruction() { Name = "parkour"; }
